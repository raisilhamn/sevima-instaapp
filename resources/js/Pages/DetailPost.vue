...
import DetailPost from "@/Components/DetailComponents.vue";
    ...
    <div>
        <div class="pl-10 mx-auto flex">
            ...
            <main class="container flex-1 pt-10">
                <div
                    class="flex max-w-5xl mx-auto bg-white rounded-lg shadow-md overflow-hidden"
                >
                    <!-- Left Section (static) -->
                    <div class="w-1/2 p-4 bg-gray-100">
                        <div>
                            <img
                                :src="`/storage/images/posts/${post.images[0].image}`"
                                alt="Post Image"
                    ...
                    <div class="w-1/2 p-4 h-[500px] overflow-y-auto">
                        <div class="flex items-center mb-4">
                            <img
                                :src="`/storage/images/profiles/${post.profileImage}`"
                                alt="Profile Image"
                        ...
                        <div class="mt-5">
                            ...
                            <div class="mt-5">
                                ...
                                >
                                    <img
                                        :src="`/storage/images/profiles/${comment.profileImage}`"
                                        alt="Profile Image"
                                ...
                                <form @submit.prevent="submit">
                                    <div class="">
                                        <textarea
                                            ...
                                            placeholder="Comments Maksimal 2.200 Karakter "
                                        ></textarea>
